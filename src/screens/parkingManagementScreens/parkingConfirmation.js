...
export default function ParkingConfirmation({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subText}>Details will be sent on mobile number & email.</Text>
        ...
        <Text style={styles.footerText}>
          You have successfully booked your Parking Spot.
        </Text>
      </View>
    </View>
  );
