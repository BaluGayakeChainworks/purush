...
export default function Tasks({ navigation }) {
  ...
  const tasks = [
    {
      id: '1',
      type: 'Patrol Nothern Slope',
      date: '2024-11-16',
      status: 'In Progress',
      description: 'Patrol & observe the northern slope of fort.',
      image: require('../../assets/patrolling.png'),
    },
    {
      id: '2',
      ...
      date: '2024-11-11',
      status: 'Resolved',
      description: 'Supervise the working site of Tilak Buidling.',
      image: require('../../assets/siteSupervision.png'),
    },
    // {
    //   id: '3',
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            <ScrollView>
              ...
              {selectedTask && (
                <>
                  <Image source={selectedTask.image} style={styles.modalImage} />
                  <Text style={styles.modalTitle}>{selectedTask.type}</Text>
                  <Text style={styles.modalDate}>Date: {selectedTask.date}</Text>
                  <Text style={styles.modalStatus}>Status: {selectedTask.status}</Text>
